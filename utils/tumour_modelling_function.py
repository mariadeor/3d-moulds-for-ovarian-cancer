...
def mesh_and_smooth(mask, stl_filename, save_preproc=False):
    """
    This function reslices and interpolates the input array to (1, 1, 1) mm
    voxel size using zero-order spline interpolation.
        INPUTS:
            mask <numpy.ndarray>: Binary array
            stl_filename <str>:   Original DICOM images voxel size.
        OUTPUTS:
            array <numpy.ndarray>:  Resliced and interpolated input array to
                                    (1, 1, 1).
    """
