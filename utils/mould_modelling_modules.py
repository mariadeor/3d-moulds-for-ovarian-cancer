...
def build_mould_cavity(tumour_wcs, tumour_replica_mesh):
    from inputs import mould_id, cavity_height_pct, cavity_wall_thickness, baseplate_xy_offset, baseplate_height, save_scad_intermediates
    ...
    tumour_w_spikes_mesh = mesh_and_smooth(tumour_w_spikes, "tumour_w_spikes", save_preproc=False)
    print("OK")
...
def build_slicing_guide(tumour_replica_mesh):
    from inputs import mould_id, slguide_height_offset, baseplate_height, cavity_wall_thickness, guides_thickness, baseplate_xy_offset, save_scad_intermediates, dist_orguide_baseplate
    from outputs import dst_dir
...
def build_orientation_guides(tumour_replica_mesh):
    from inputs import guides_thickness, baseplate_xy_offset, dist_orguide_baseplate, baseplate_height, save_scad_intermediates, mould_id, slguide_height_offset
    from outputs import dst_dir
...
def carve_slicing_slits(scad_mould, tumour_replica_mesh):
    from inputs import slit_thickness, guides_thickness, baseplate_xy_offset, slguide_height_offset, baseplate_height, slice_thickness, dist_orguide_baseplate, depth_orslit, cavity_height_pct
...
def build_mould(tumour_wcs):
    ...
    from inputs import save_scad_intermediates, mould_id
    from outputs import dst_dir
    ...
    if save_scad_intermediates:  # OPT: Add "--save_scad_intermediates" to the command line to save the scad file of the complete mould without slits.
        scad_render_to_file(
            scad_mould,
    ...
    scad_mould, slicing_slits_positions = carve_slicing_slits(scad_mould, tumour_replica_mesh)
