...
from utils.array_modules import (build_label_mask, get_centroid,
                                 get_mask_slices_dicom_idx, rotate_label_mask)
from utils.dicom_modules import get_roi_masks
from utils.export_modules import create_dst_dir
#from utils.display_functions import plot_tumour_outlines
from utils.import_modules import (build_parser, check_dicom_info,
                                  check_tunable_parameters, import_yaml)
...
original_tumour_dicom_slices = get_mask_slices_dicom_idx(tumour_mask)  # Used when printing the tumour slices outlines.
print(" OK")

create_dst_dir(save_inputs=True)  # Create folder to save the results and save copies of the yaml inputs used to generate the mould.
...
plot_tumour_outlines(tumour_rotated, original_tumour_dicom_slices, slicing_slits_positions, cavity_height)
